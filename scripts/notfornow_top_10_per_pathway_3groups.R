...
generate_heatmap <- function(gene_list, title, file_name) {
  ...
  ann_colors <- list(Group = c("1" = "#17becf", "3" = "#ff7"))  # Cyan for Group1, Orange for Group4
  ...
  ordered_indices_group_3 <- reorder_within_group(gene_matrix, annotation, "3")
  
  # Combine ordered indices
  final_ordered_indices <- c(ordered_indices_group_1, ordered_indices_group_3)
