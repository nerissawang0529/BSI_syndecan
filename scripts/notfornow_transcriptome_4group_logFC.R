...
# Cutting the sorted data into three equal parts (1, 2, 3,4)
...
BSI_transcriptome_2 <- BSI_transcriptome %>% filter(Syndecan_group != 2 & Syndecan_group != 3)

BSI_transcriptome_2$Group <- factor(BSI_transcriptome_2$Syndecan_group, levels = c(1, 4))
